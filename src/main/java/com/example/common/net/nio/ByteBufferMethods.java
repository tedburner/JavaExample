package com.example.common.net.nio;
...
public class ByteBufferMethods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------Test reset position----------------");
        ...
        buffer.mark();
        buffer.position(10);
        System.out.println("before reset position : " + buffer);
        System.out.println();
        ...
        buffer.get(data, 0, 2);
        System.out.println("after get(data, 0, 2) : " + buffer);
        System.out.println("\t dst:" + new String(data));
        ...
        bb.put(2, (byte) 'c');
        System.out.println("buffer is : " + bb);
